...
public class PersistenceGatewayImpl implements PersistenceGateway,
	...
	private void createIndexesAndConstraints() {
		...
		// Name, Tag and Link Property should not need to be unique -> try to find other unique properties
...
//				+ LinkProperty.URL + ")");
	...
	@Override
	public void setLinkPropertyValue(final String linkUUID,
	...
	private Link convert(final Node linkNode) {
		...
		int clicks = Integer.valueOf(String.valueOf(linkNode
				.getProperty(Link.CLICK_COUNT)));
		double score = Double.valueOf(String.valueOf(linkNode
